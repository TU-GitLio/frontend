  ...
  return (
    <>
      <div className="w-full h-full grid bg-primary grid-cols-5 grid-rows-9">
        ...
        <EditHeader />
        <div className="col-span-3 row-span-8 h-full bg-primary border border-blue-400">
        ...
        <div className="flex justify-center items-center col-span-1 row-span-8 h-full bg-primary border border-blue-400">
